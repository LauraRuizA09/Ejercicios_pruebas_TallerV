...
/*8.4.6 GPIOx_ODR (un bit por cada PIN)  -  estes es el registro para escribir el estado de un
...
/* Defincion de los nombres de los pines */
...
typedef struct{
	...
	uint8_t GPIO_PinPuPdControl;		//Turn ON-OFF the pull_up and pull_down resistor for working plan
	uint8_t GPIO_PinOutputType;			//Selects output type: push-pull or openDrain
	uint8_t GPIO_PinAltFunMode;			//Type of alternate function assigened to working plan
...
#define IS_GPIO_OSPEED(SPEED)		(((SPEED) == GPIO_SPEED_LOW)   ||  \
